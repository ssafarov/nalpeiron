 ...
 * @see https://github.com/NTICompass/PHP-Base32
 */
class Base32
{
    ...
    function __construct($alphabet = 'rfc4648')
    {
        ...
        $alphabets = array(
            ...
            'custom=' => str_split(strtoupper('abcdefghijkmnpqrstuvwxyz23456789=')),
            'custom' => array_merge(str_split(strtoupper('abcdefghijkmnpqrstuvwxyz23456789')), ['']),
        );
